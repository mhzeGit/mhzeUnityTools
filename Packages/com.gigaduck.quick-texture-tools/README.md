...
## What This Tool Does
Quick Texture Tools provides fast, repeatable texture operations directly in Unity: invert RGB, generate mask maps, flip normal Y channel, and whiten textures while keeping alpha.
...
- `Assets/Quick Texture Tools/Invert`
- `Assets/Quick Texture Tools/Normal Y-Flip`
- `Assets/Quick Texture Tools/Whiten`
- `Assets/Quick Texture Tools/Mask Map...`

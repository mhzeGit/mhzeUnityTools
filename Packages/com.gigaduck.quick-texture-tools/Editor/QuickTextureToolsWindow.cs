...
namespace Gigaduck.QuickTextureTools.Editor
{
    public class QuickTextureToolsWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Quick Texture Tools")]
        public static void Open()
        {
            var win = GetWindow<QuickTextureToolsWindow>("Quick Texture Tools");
        ...
        [MenuItem("Assets/Quick Texture Tools/Invert", true)]
        [MenuItem("Assets/Quick Texture Tools/Normal Y-Flip", true)]
        [MenuItem("Assets/Quick Texture Tools/Whiten", true)]
        ...
        [MenuItem("Assets/Quick Texture Tools/Mask Map/Auto Set Textures", true)]
        [MenuItem("Assets/Quick Texture Tools/Mask Map/Set as Metallic", true)]
        [MenuItem("Assets/Quick Texture Tools/Mask Map/Set as Roughness", true)]
        [MenuItem("Assets/Quick Texture Tools/Mask Map/Set as Ambient Occlusion", true)]
        [MenuItem("Assets/Quick Texture Tools/Mask Map/Set as Detail Mask", true)]
        private static bool ValidateMaskMapMenu()
        {
            return GetSelectedTextures().Length > 0;
        }

        [MenuItem("Assets/Quick Texture Tools/Invert")]
        ...
        [MenuItem("Assets/Quick Texture Tools/Normal Y-Flip")]
        ...
        [MenuItem("Assets/Quick Texture Tools/Whiten")]
        ...
        private static void ProcessTextures(Object[] textures, PixelProcessor processor, string verb, string suffix)
        {
            ...
            if (processed > 0)
            {
                Debug.Log($"[Quick Texture Tools] {verb}: {processed} duplicate(s) created.");
            }
            else
            {
                EditorUtility.DisplayDialog("Quick Texture Tools", "No valid textures to process.", "OK");
            }
        }
